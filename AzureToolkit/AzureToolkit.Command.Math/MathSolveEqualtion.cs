    ...
    public class MathSolveEqualtion : ICommand
    {
        public static int Execute(string[] args)
        {
            ...
            if (option == "--degree-1")
            {
                ...
                {
                    double solution = -b / k;
                    Output.WriteLineWithColor($"方程的解为: x = {solution}", ConsoleColor.White);
                }
                return 0;
            }
        ...
        public static int PrintHelpMessage()
        {
            ...
            Output.WriteLineWithColor("例如: 方程 2x^2 + 3x + 1 = 0 的系数为 2, 3, 1", ConsoleColor.Green);
            Output.WriteLineWithColor("例如: 方程 2x^2 + 3x + 1 = 1 的系数为 2, 3, 0", ConsoleColor.Green);
